...
public class query02 {
	...
	public static void main(String[] args) {
		/**
		 * 2. Mostrar todas las peliculas en las que el nombre de director empieza por M
			SELECT * FROM videoclub.peliculas WHERE director LIKE 'M%';
		 */
		...
		TypedQuery query = em.createQuery("SELECT p"
				+ " FROM Pelicula p"
				+ " WHERE p.director LIKE 'M%'", Pelicula.class);
